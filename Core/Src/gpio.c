...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, GRAY_ADD_0_Pin|GRAY_ADD_1_Pin|GRAY_ADD_2_Pin|GRAY_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GRAY_ADD_0_Pin GRAY_ADD_1_Pin GRAY_ADD_2_Pin GRAY_EN_Pin */
  GPIO_InitStruct.Pin = GRAY_ADD_0_Pin|GRAY_ADD_1_Pin|GRAY_ADD_2_Pin|GRAY_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
